...
schema_view = get_schema_view(
    openapi.Info(
        title="Documentation TicketSystem API",
        default_version='v1',
        description="Documentation API for the usage of TicketSystem",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="kapalma05@gmail.com"),
...
urlpatterns = [
    ...
    # path('api/v1/', include('apps.core.api.routers')),
